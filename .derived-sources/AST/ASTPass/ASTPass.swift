...
public protocol ASTPass {
  ...
  func process(enumMember: EnumMember, passContext: ASTPassContext) -> ASTPassResult<EnumMember>
  func postProcess(enumMember: EnumMember, passContext: ASTPassContext) -> ASTPassResult<EnumMember>
  ...
  func process(externalCall: ExternalCall, passContext: ASTPassContext) -> ASTPassResult<ExternalCall>
  func postProcess(externalCall: ExternalCall, passContext: ASTPassContext) -> ASTPassResult<ExternalCall>
  ...
  func process(token: Token, passContext: ASTPassContext) -> ASTPassResult<Token>
  func postProcess(token: Token, passContext: ASTPassContext) -> ASTPassResult<Token>
...
extension ASTPass {
  ...
  public func process(enumMember: EnumMember, passContext: ASTPassContext) -> ASTPassResult<EnumMember> {
    return ASTPassResult(element: enumMember, diagnostics: [], passContext: passContext)
  }

  public func postProcess(enumMember: EnumMember, passContext: ASTPassContext) -> ASTPassResult<EnumMember> {
    return ASTPassResult(element: enumMember, diagnostics: [], passContext: passContext)
  }
  ...
  public func postProcess(externalCall: ExternalCall, passContext: ASTPassContext) -> ASTPassResult<ExternalCall> {
    return ASTPassResult(element: externalCall, diagnostics: [], passContext: passContext)
  }
  ...
  public func postProcess(token: Token, passContext: ASTPassContext) -> ASTPassResult<Token> {
    return ASTPassResult(element: token, diagnostics: [], passContext: passContext)
  }
